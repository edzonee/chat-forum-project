"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global&&global;class e{constructor(e){this.div=e,this.div=e}makeElements(){this.createDiv=document.createElement("div"),this.createDiv.setAttribute("id","main"),document.body.append(this.createDiv),this.createDiv.style.justifyContent="center",this.createDiv.style.alignItems="center";const e=document.createElement("h1");this.createDiv.appendChild(e),e.setAttribute("id","title"),e.innerText="Welcome. Write your name </>",document.querySelector("main");const t=document.createElement("form");t.setAttribute("id","nameInfo"),this.createDiv.appendChild(t),document.querySelector("form");const n=document.createElement("input");n.setAttribute("id","userNameInput"),t.appendChild(n).placeholder="Enter you name",document.querySelector("main");const i=document.createElement("button");i.setAttribute("id","submitName"),t.appendChild(i),i.innerText="Enter name";const s=document.createElement("div");s.setAttribute("id","messageForm"),this.createDiv.appendChild(s),s.style.display="none",document.querySelector("messageForm");const r=document.createElement("textarea");s.appendChild(r).placeholder="Write your message",r.setAttribute("id","userMessageInput"),r.style.height="150px",r.style.width="500px";const o=document.createElement("div");o.setAttribute("id","databaseInfo"),this.createDiv.append(o),o.style.textAlign="center",o.style.display="none";const a=document.createElement("p");a.setAttribute("id","database-comments"),a.setAttribute("value","database-comments"),o.appendChild(a),o.style.border="1px solid rgb(153, 255, 0)",o.style.margin="2rem",o.style.height="500px",o.style.width="750px",o.style.textAlign="center",o.style.overflowY="scroll"}changeElements(){document.getElementById("submitName").innerText="Submit";const e=document.querySelector("#userNameInput");document.getElementById("title").innerText=`Welcome ${e.value}. Write your message below...`;document.getElementById("messageForm").style.display="block";document.getElementById("databaseInfo").style.display="block"}plsWriteName(){document.getElementById("title").innerText="Please write your name..."}}
/**
 * @license
 ...
 * limitations under the License.
 */
function _(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}function f(){return"undefined"!=typeof window&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(_())}function m(){return!0===t||!0===n}class g extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name="FirebaseError",Object.setPrototypeOf(this,g.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,y.prototype.create)}}class y{constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}create(e,...t){const n=t[0]||{},i=`${this.service}/${e}`,s=this.errors[e],r=s?function(e,t){return e.replace(v,((e,n)=>{const i=t[n];return null!=i?String(i):`<${n}?>`}))}(s,n):"Error",o=`${this.serviceName}: ${r} (${i}).`;return new g(i,o,n)}}const v=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const j=[];var H;!function(e){e[e.DEBUG=0]="DEBUG",e[e.VERBOSE=1]="VERBOSE",e[e.INFO=2]="INFO",e[e.WARN=3]="WARN",e[e.ERROR=4]="ERROR",e[e.SILENT=5]="SILENT"}(H||(H={}));const B={debug:H.DEBUG,verbose:H.VERBOSE,info:H.INFO,warn:H.WARN,error:H.ERROR,silent:H.SILENT},z=H.INFO,$={[H.DEBUG]:"log",[H.VERBOSE]:"log",[H.INFO]:"info",[H.WARN]:"warn",[H.ERROR]:"error"},V=(e,t,...n)=>{if(t<e.logLevel)return;const i=(new Date).toISOString(),s=$[t];if(!s)throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`);console[s](`[${i}]  ${e.name}:`,...n)};class Y{constructor(e){this.name=e,this._logLevel=z,this._logHandler=V,this._userLogHandler=null,j.push(this)}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in H))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel="string"==typeof e?B[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,H.DEBUG,...e),this._logHandler(this,H.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,H.VERBOSE,...e),this._logHandler(this,H.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,H.INFO,...e),this._logHandler(this,H.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,H.WARN,...e),this._logHandler(this,H.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,H.ERROR,...e),this._logHandler(this,H.ERROR,...e)}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht extends It{constructor(){let e,t;super(["visible"]),"undefined"!=typeof document&&void 0!==document.addEventListener&&(void 0!==document.hidden?(t="visibilitychange",e="hidden"):void 0!==document.mozHidden?(t="mozvisibilitychange",e="mozHidden"):void 0!==document.msHidden?(t="msvisibilitychange",e="msHidden"):void 0!==document.webkitHidden&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,(()=>{const t=!document[e];t!==this.visible_&&(this.visible_=t,this.trigger("visible",t))}),!1)}static getInstance(){return new Ht}getInitialEvent(e){return s("visible"===e,"Unknown event type: "+e),[this.visible_]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $t{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new zt("[MIN_NAME]",e),i=new zt("[MIN_NAME]",t);return 0!==this.compare(n,i)}minPost(){return zt.MIN}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vt;class Yt extends $t{static get __EMPTY_NODE(){return Vt}static set __EMPTY_NODE(e){Vt=e}compare(e,t){return Ge(e.name,t.name)}isDefinedOn(e){throw r("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return zt.MIN}maxPost(){return new zt("[MAX_NAME]",Vt)}makePost(e,t){return s("string"==typeof e,"KeyIndex indexValue must always be a string."),new zt(e,Vt)}toString(){return".key"}}const Gt=new Yt;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wn{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new qn(e);const n=1e4+2e4*Math.random();st(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Ze(e,((e,i)=>{i>0&&I(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),st(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Un,jn;function Hn(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(jn=Un||(Un={}))[jn.OVERWRITE=0]="OVERWRITE",jn[jn.MERGE=1]="MERGE",jn[jn.ACK_USER_WRITE=2]="ACK_USER_WRITE",jn[jn.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class Bn{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Un.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}operationForChild(e){if(Mt(this.path)){if(null!=this.affectedTree.value)return s(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Tt(e));return new Bn(St(),t,this.revert)}}return s(kt(this.path)===e,"operationForChild called for unrelated child."),new Bn(Pt(this.path),this.affectedTree,this.revert)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(e,t){this.source=e,this.path=t,this.type=Un.LISTEN_COMPLETE}operationForChild(e){return Mt(this.path)?new zn(this.source,St()):new zn(this.source,Pt(this.path))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Un.OVERWRITE}operationForChild(e){return Mt(this.path)?new $n(this.source,St(),this.snap.getImmediateChild(e)):new $n(this.source,Pt(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vn{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Un.MERGE}operationForChild(e){if(Mt(this.path)){const t=this.children.subtree(new Tt(e));return t.isEmpty()?null:t.value?new $n(this.source,St(),t.value):new Vn(this.source,St(),t)}return s(kt(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Vn(this.source,Pt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ri(e,t,n,i,o){const a=new Ni;let l,h;if(n.type===Un.OVERWRITE){const r=n;r.source.fromUser?l=Mi(e,t,r.path,r.snap,i,o,a):(s(r.source.fromServer,"Unknown source."),h=r.source.tagged||t.serverCache.isFiltered()&&!Mt(r.path),l=Ai(e,t,r.path,r.snap,i,o,h,a))}else if(n.type===Un.MERGE){const r=n;r.source.fromUser?l=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,l)=>{const h=At(n,i);Oi(t,kt(h))&&(a=Mi(e,a,h,l,s,r,o))})),i.foreach(((i,l)=>{const h=At(n,i);Oi(t,kt(h))||(a=Mi(e,a,h,l,s,r,o))})),a}(e,t,r.path,r.children,i,o,a):(s(r.source.fromServer,"Unknown source."),h=r.source.tagged||t.serverCache.isFiltered(),l=Fi(e,t,r.path,r.children,i,o,h,a))}else if(n.type===Un.ACK_USER_WRITE){const r=n;l=r.revert?function(e,t,n,i,r,o){let a;if(null!=Ii(i,n))return t;{const l=new xi(i,t,r),h=t.eventCache.getNode();let c;if(Mt(n)||".priority"===kt(n)){let n;if(t.serverCache.isFullyInitialized())n=Ci(i,ei(t));else{const e=t.serverCache.getNode();s(e instanceof mn,"serverChildren would be complete if leaf node"),n=wi(i,e)}c=e.filter.updateFullNode(h,n,o)}else{const s=kt(n);let r=Ti(i,s,t.serverCache);null==r&&t.serverCache.isCompleteForChild(s)&&(r=h.getImmediateChild(s)),c=null!=r?e.filter.updateChild(h,s,r,Pt(n),l,o):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(h,s,mn.EMPTY_NODE,Pt(n),l,o):h,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(a=Ci(i,ei(t)),a.isLeafNode()&&(c=e.filter.updateFullNode(c,a,o)))}return a=t.serverCache.isFullyInitialized()||null!=Ii(i,St()),Xn(t,c,a,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let zi,$i;class Vi{constructor(){this.views=new Map}}function Yi(e,t,n,i){const r=t.source.queryId;if(null!==r){const o=e.views.get(r);return s(null!=o,"SyncTree gave us an op for an invalid query."),Hi(o,t,n,i)}{let s=[];for(const r of e.views.values())s=s.concat(Hi(r,t,n,i));return s}}function Gi(e,t,n,i,s){const r=t._queryIdentifier,o=e.views.get(r);if(!o){let e=Ci(n,s?i:null),r=!1;e?r=!0:i instanceof mn?(e=wi(n,i),r=!1):(e=mn.EMPTY_NODE,r=!1);const o=Qn(new Yn(e,r,!1),new Yn(i,s,!1));return new qi(t,o)}return o}function Ki(e,t,n,i,s,r){const o=Gi(e,t,i,s,r);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,o),function(e,t){e.eventRegistrations_.push(t)}(o,n),function(e,t){const n=e.viewCache_.eventCache,i=[];n.getNode().isLeafNode()||n.getNode().forEachChild(ln,((e,t)=>{i.push(En(e,t))}));return n.isFullyInitialized()&&i.push(In(n.getNode())),Bi(e,i,n.getNode(),t)}(o,n)}function Qi(e,t,n,i){const r=t._queryIdentifier,o=[];let a=[];const l=ts(e);if("default"===r)for(const[t,s]of e.views.entries())a=a.concat(ji(s,n,i)),Ui(s)&&(e.views.delete(t),s.query._queryParams.loadsAllData()||o.push(s.query));else{const t=e.views.get(r);t&&(a=a.concat(ji(t,n,i)),Ui(t)&&(e.views.delete(r),t.query._queryParams.loadsAllData()||o.push(t.query)))}return l&&!ts(e)&&o.push(new(s(zi,"Reference.ts has not been loaded"),zi)(t._repo,t._path)),{removed:o,events:a}}function Xi(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function Ji(e,t){let n=null;for(const i of e.views.values())n=n||Wi(i,t);return n}function Zi(e,t){if(t._queryParams.loadsAllData())return ns(e);{const n=t._queryIdentifier;return e.views.get(n)}}function es(e,t){return null!=Zi(e,t)}function ts(e){return null!=ns(e)}function ns(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let is=1;class ss{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ni(null),this.pendingWriteTree_={visibleWrites:ii.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function rs(e,t,n,i,r){return function(e,t,n,i,r){s(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=si(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?ps(e,new $n({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function os(e,t,n,i){!function(e,t,n,i){s(i>e.lastWriteId,"Stacking an older merge on top of newer ones"),e.allWrites.push({path:t,children:n,writeId:i,visible:!0}),e.visibleWrites=ri(e.visibleWrites,t,n),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i);const r=ni.fromObject(n);return ps(e,new Vn({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,r))}function as(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(fi(e.pendingWriteTree_,t)){let t=new ni(null);return null!=i.snap?t=t.set(St(),!0):Ze(i.children,(e=>{t=t.set(new Tt(e),!0)})),ps(e,new Bn(i.path,t,n))}return[]}function ls(e,t,n){return ps(e,new $n({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function hs(e,t,n,i){const s=t._path,r=e.syncPointTree_.get(s);let o=[];if(r&&("default"===t._queryIdentifier||es(r,t))){const a=Qi(r,t,n,i);0===r.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));const l=a.removed;o=a.events;const h=-1!==l.findIndex((e=>e._queryParams.loadsAllData())),c=e.syncPointTree_.findOnPath(s,((e,t)=>ts(t)));if(h&&!c){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&ts(t)){return[ns(t)]}{let e=[];return t&&(e=Xi(t)),Ze(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],s=i.query,r=ms(e,i);e.listenProvider_.startListening(bs(s),gs(e,s),r.hashFn,r.onComplete)}}}if(!c&&l.length>0&&!i)if(h){const n=null;e.listenProvider_.stopListening(bs(t),n)}else l.forEach((t=>{const n=e.queryToTagMap.get(ys(t));e.listenProvider_.stopListening(bs(t),n)}));!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=ys(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,l)}return o}function cs(e,t,n){const i=t._path;let r=null,o=!1;e.syncPointTree_.foreachOnPath(i,((e,t)=>{const n=Ot(e,i);r=r||Ji(t,n),o=o||ts(t)}));let a,l=e.syncPointTree_.get(i);if(l?(o=o||ts(l),r=r||Ji(l,St())):(l=new Vi,e.syncPointTree_=e.syncPointTree_.set(i,l)),null!=r)a=!0;else{a=!1,r=mn.EMPTY_NODE;e.syncPointTree_.subtree(i).foreachChild(((e,t)=>{const n=Ji(t,St());n&&(r=r.updateImmediateChild(e,n))}))}const h=es(l,t);if(!h&&!t._queryParams.loadsAllData()){const n=ys(t);s(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const i=is++;e.queryToTagMap.set(n,i),e.tagToQueryMap.set(i,n)}let c=Ki(l,t,n,_i(e.pendingWriteTree_,i),r,a);if(!h&&!o){const n=Zi(l,t);c=c.concat(function(e,t,n){const i=t._path,r=gs(e,t),o=ms(e,n),a=e.listenProvider_.startListening(bs(t),r,o.hashFn,o.onComplete),l=e.syncPointTree_.subtree(i);if(r)s(!ts(l.value),"If we're adding a query, it shouldn't be shadowed");else{const t=l.fold(((e,t,n)=>{if(!Mt(e)&&t&&ts(t))return[ns(t).query];{let e=[];return t&&(e=e.concat(Xi(t).map((e=>e.query)))),Ze(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(bs(i),gs(e,i))}}return a}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return c}function us(e,t,n){const i=e.pendingWriteTree_,s=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Ji(n,Ot(e,t));if(i)return i}));return vi(i,t,s,n,!0)}function ds(e,t){const n=t._path;let i=null;e.syncPointTree_.foreachOnPath(n,((e,t)=>{const s=Ot(e,n);i=i||Ji(t,s)}));let s=e.syncPointTree_.get(n);s?i=i||Ji(s,St()):(s=new Vi,e.syncPointTree_=e.syncPointTree_.set(n,s));const r=null!=i,o=r?new Yn(i,!0,!1):null;return function(e){return Zn(e.viewCache_)}(Gi(s,t,_i(e.pendingWriteTree_,t._path),r?o.getNode():mn.EMPTY_NODE,r))}function ps(e,t){return _s(t,e.syncPointTree_,null,_i(e.pendingWriteTree_,St()))}function _s(e,t,n,i){if(Mt(e.path))return fs(e,t,n,i);{const s=t.get(St());null==n&&null!=s&&(n=Ji(s,St()));let r=[];const o=kt(e.path),a=e.operationForChild(o),l=t.children.get(o);if(l&&a){const e=n?n.getImmediateChild(o):null,t=Si(i,o);r=r.concat(_s(a,l,e,t))}return s&&(r=r.concat(Yi(s,e,i,n))),r}}function fs(e,t,n,i){const s=t.get(St());null==n&&null!=s&&(n=Ji(s,St()));let r=[];return t.children.inorderTraversal(((t,s)=>{const o=n?n.getImmediateChild(t):null,a=Si(i,t),l=e.operationForChild(t);l&&(r=r.concat(fs(l,s,o,a)))})),s&&(r=r.concat(Yi(s,e,i,n))),r}function ms(e,t){const n=t.query,i=gs(e,n);return{hashFn:()=>{const e=function(e){return e.viewCache_.serverCache.getNode()}(t)||mn.EMPTY_NODE;return e.hash()},onComplete:t=>{if("ok"===t)return i?function(e,t,n){const i=vs(e,n);if(i){const n=Cs(i),s=n.path,r=n.queryId,o=Ot(s,t);return ws(e,s,new zn(Hn(r),o))}return[]}(e,n._path,i):function(e,t){return ps(e,new zn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const i=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const i=new Error(e+" at "+t._path.toString()+": "+n);return i.code=e.toUpperCase(),i}(t,n);return hs(e,n,null,i)}}}}function gs(e,t){const n=ys(t);return e.queryToTagMap.get(n)}function ys(e){return e._path.toString()+"$"+e._queryIdentifier}function vs(e,t){return e.tagToQueryMap.get(t)}function Cs(e){const t=e.indexOf("$");return s(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Tt(e.substr(0,t))}}function ws(e,t,n){const i=e.syncPointTree_.get(t);s(i,"Missing sync point for query tag that we're tracking");return Yi(i,n,_i(e.pendingWriteTree_,t),null)}function bs(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(s($i,"Reference.ts has not been loaded"),$i)(e._repo,e._path):e}class Is{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Is(t)}node(){return this.node_}}class Es{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=At(this.path_,e);return new Es(this.syncTree_,t)}node(){return us(this.syncTree_,this.path_)}}const Ts=function(e,t,n){return e&&"object"==typeof e?(s(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?Ss(e[".sv"],t,n):"object"==typeof e[".sv"]?ks(e[".sv"],t):void s(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Ss=function(e,t,n){if("timestamp"===e)return n.timestamp;s(!1,"Unexpected server value: "+e)},ks=function(e,t,n){e.hasOwnProperty("increment")||s(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const i=e.increment;"number"!=typeof i&&s(!1,"Unexpected increment value: "+i);const r=t.node();if(s(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return i;const o=r.getValue();return"number"!=typeof o?i:o+i},Ns=function(e,t,n,i){return xs(t,new Es(n,e),i)},Ps=function(e,t,n){return xs(e,new Is(t),n)};function xs(e,t,n){const i=e.getPriority().val(),s=Ts(i,t.getImmediateChild(".priority"),n);let r;if(e.isLeafNode()){const i=e,r=Ts(i.getValue(),t,n);return r!==i.getValue()||s!==i.getPriority().val()?new an(r,yn(s)):e}{const i=e;return r=i,s!==i.getPriority().val()&&(r=r.updatePriority(new an(s))),i.forEachChild(ln,((e,i)=>{const s=xs(i,t.getImmediateChild(e),n);s!==i&&(r=r.updateImmediateChild(e,s))})),r}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rs{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function Ds(e,t){let n=t instanceof Tt?t:new Tt(t),i=e,s=kt(n);for(;null!==s;){const e=E(i.node.children,s)||{children:{},childCount:0};i=new Rs(s,i,e),n=Pt(n),s=kt(n)}return i}function As(e){return e.node.value}function Ms(e,t){e.node.value=t,Ws(e)}function Os(e){return e.node.childCount>0}function Ls(e,t){Ze(e.node.children,((n,i)=>{t(new Rs(n,e,i))}))}function Fs(e,t,n,i){n&&!i&&t(e),Ls(e,(e=>{Fs(e,t,!0,i)})),n&&i&&t(e)}function qs(e){return new Tt(null===e.parent?e.name:qs(e.parent)+"/"+e.name)}function Ws(e){null!==e.parent&&function(e,t,n){const i=function(e){return void 0===As(e)&&!Os(e)}(n),s=I(e.node.children,t);i&&s?(delete e.node.children[t],e.node.childCount--,Ws(e)):i||s||(e.node.children[t]=n.node,e.node.childCount++,Ws(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e.parent,e.name,e)}const Us=/[\[\].#$\/\u0000-\u001F\u007F]/,js=/[\[\].#$\u0000-\u001F\u007F]/,Hs=function(e){return"string"==typeof e&&0!==e.length&&!Us.test(e)},Bs=function(e){return"string"==typeof e&&0!==e.length&&!js.test(e)},zs=function(e){return null===e||"string"==typeof e||"number"==typeof e&&!Ye(e)||e&&"object"==typeof e&&I(e,".sv")},$s=function(e,t,n,i){i&&void 0===t||Vs(x(e,"value"),t,n)},Vs=function(e,t,n){const i=n instanceof Tt?new Wt(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+jt(i));if("function"==typeof t)throw new Error(e+"contains a function "+jt(i)+" with contents = "+t.toString());if(Ye(t))throw new Error(e+"contains "+t.toString()+" "+jt(i));if("string"==typeof t&&t.length>10485760/3&&R(t)>10485760)throw new Error(e+"contains a string greater than 10485760 utf8 bytes "+jt(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,s=!1;if(Ze(t,((t,r)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(s=!0,!Hs(t)))throw new Error(e+" contains an invalid key ("+t+") "+jt(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');!function(e,t){e.parts_.length>0&&(e.byteLength_+=1),e.parts_.push(t),e.byteLength_+=R(t),Ut(e)}(i,t),Vs(e,r,i),function(e){const t=e.parts_.pop();e.byteLength_-=R(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)})),n&&s)throw new Error(e+' contains ".value" child '+jt(i)+" in addition to actual children.")}},Ys=function(e,t,n,i){if(i&&void 0===t)return;const s=x(e,"values");if(!t||"object"!=typeof t||Array.isArray(t))throw new Error(s+" must be an object containing the children to replace.");const r=[];Ze(t,((e,t)=>{const i=new Tt(e);if(Vs(s,t,At(n,i)),".priority"===xt(i)&&!zs(t))throw new Error(s+"contains an invalid value for '"+i.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(i)})),function(e,t){let n,i;for(n=0;n<t.length;n++){i=t[n];const s=Rt(i);for(let t=0;t<s.length;t++)if(".priority"===s[t]&&t===s.length-1);else if(!Hs(s[t]))throw new Error(e+"contains an invalid key ("+s[t]+") in path "+i.toString()+'. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"')}t.sort(Lt);let s=null;for(n=0;n<t.length;n++){if(i=t[n],null!==s&&qt(s,i))throw new Error(e+"contains a path "+s.toString()+" that is ancestor of another path "+i.toString());s=i}}(s,r)},Gs=function(e,t,n,i){if(!(i&&void 0===n||Bs(n)))throw new Error(x(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Ks=function(e,t){if(".info"===kt(t))throw new Error(e+" failed = Can't modify data under /.info/")},Qs=function(e,t){const n=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!Hs(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Bs(e)}(n))throw new Error(x(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Xs{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Js(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Ft(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Zs(e,t,n){Js(e,n),tr(e,(e=>Ft(e,t)))}function er(e,t,n){Js(e,n),tr(e,(e=>qt(e,t)||qt(t,e)))}function tr(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(nr(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function nr(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();We&&He("event: "+n.toString()),it(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ir{constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Xs,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=On(),this.transactionQueueTree_=new Rs,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function sr(e,t,n){if(e.stats_=_t(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new An(e.repoInfo_,((t,n,i,s)=>{ar(e,t,n,i,s)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>lr(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{w(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Bt(e.repoInfo_,t,((t,n,i,s)=>{ar(e,t,n,i,s)}),(t=>{lr(e,t)}),(t=>{!function(e,t){Ze(t,((t,n)=>{hr(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return pt[n]||(pt[n]=t()),pt[n]}(e.repoInfo_,(()=>new Wn(e.stats_,e.server_))),e.infoData_=new Mn,e.infoSyncTree_=new ss({startListening:(t,n,i,s)=>{let r=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(r=ls(e.infoSyncTree_,t._path,o),setTimeout((()=>{s("ok")}),0)),r},stopListening:()=>{}}),hr(e,"connected",!1),e.serverSyncTree_=new ss({startListening:(t,n,i,s)=>(e.server_.listen(t,i,n,((n,i)=>{const r=s(n,i);er(e.eventQueue_,t._path,r)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function rr(e){const t=e.infoData_.getNode(new Tt(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function or(e){return(t=(t={timestamp:rr(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function ar(e,t,n,i,s){e.dataUpdateCount++;const r=new Tt(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(s)if(i){const t=S(n,(e=>yn(e)));o=function(e,t,n,i){const s=vs(e,i);if(s){const i=Cs(s),r=i.path,o=i.queryId,a=Ot(r,t),l=ni.fromObject(n);return ws(e,r,new Vn(Hn(o),a,l))}return[]}(e.serverSyncTree_,r,t,s)}else{const t=yn(n);o=function(e,t,n,i){const s=vs(e,i);if(null!=s){const i=Cs(s),r=i.path,o=i.queryId,a=Ot(r,t);return ws(e,r,new $n(Hn(o),a,n))}return[]}(e.serverSyncTree_,r,t,s)}else if(i){const t=S(n,(e=>yn(e)));o=function(e,t,n){const i=ni.fromObject(n);return ps(e,new Vn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,r,t)}else{const t=yn(n);o=ls(e.serverSyncTree_,r,t)}let a=r;o.length>0&&(a=yr(e,r)),er(e.eventQueue_,a,o)}function lr(e,t){hr(e,"connected",t),!1===t&&function(e){_r(e,"onDisconnectEvents");const t=or(e),n=On();Fn(e.onDisconnect_,St(),((i,s)=>{const r=Ns(i,s,e.serverSyncTree_,t);Ln(n,i,r)}));let i=[];Fn(n,St(),((t,n)=>{i=i.concat(ls(e.serverSyncTree_,t,n));const s=Ir(e,t);yr(e,s)})),e.onDisconnect_=On(),er(e.eventQueue_,St(),i)}(e)}function hr(e,t,n){const i=new Tt("/.info/"+t),s=yn(n);e.infoData_.updateSnapshot(i,s);const r=ls(e.infoSyncTree_,i,s);er(e.eventQueue_,i,r)}function cr(e){return e.nextWriteId_++}function ur(e,t,n,i,s){_r(e,"set",{path:t.toString(),value:n,priority:i});const r=or(e),o=yn(n,i),a=us(e.serverSyncTree_,t),l=Ps(o,a,r),h=cr(e),c=rs(e.serverSyncTree_,t,l,h,!0);Js(e.eventQueue_,c),e.server_.put(t.toString(),o.val(!0),((n,i)=>{const r="ok"===n;r||Ve("set at "+t+" failed: "+n);const o=as(e.serverSyncTree_,h,!r);er(e.eventQueue_,t,o),fr(e,s,n,i)}));const u=Ir(e,t);yr(e,u),er(e.eventQueue_,u,[])}function dr(e,t,n){let i;i=".info"===kt(t._path)?hs(e.infoSyncTree_,t,n):hs(e.serverSyncTree_,t,n),Zs(e.eventQueue_,t._path,i)}function pr(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function _r(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),He(n,...t)}function fr(e,t,n,i){t&&it((()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let s=e;i&&(s+=": "+i);const r=new Error(s);r.code=e,t(r)}}))}function mr(e,t,n){return us(e.serverSyncTree_,t,n)||mn.EMPTY_NODE}function gr(e,t=e.transactionQueueTree_){if(t||br(e,t),As(t)){const n=Cr(e,t);s(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const i=n.map((e=>e.currentWriteId)),r=mr(e,t,i);let o=r;const a=r.hash();for(let e=0;e<n.length;e++){const i=n[e];s(0===i.status,"tryToSendTransactionQueue_: items in queue should all be run."),i.status=1,i.retryCount++;const r=Ot(t,i.path);o=o.updateChild(r,i.currentOutputSnapshotRaw)}const l=o.val(!0),h=t;e.server_.put(h.toString(),l,(i=>{_r(e,"transaction put response",{path:h.toString(),status:i});let s=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,s=s.concat(as(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();br(e,Ds(e.transactionQueueTree_,t)),gr(e,e.transactionQueueTree_),er(e.eventQueue_,t,s);for(let e=0;e<i.length;e++)it(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{Ve("transaction at "+h.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}yr(e,t)}}),a)}(e,qs(t),n)}else Os(t)&&Ls(t,(t=>{gr(e,t)}))}function yr(e,t){const n=vr(e,t),i=qs(n);return function(e,t,n){if(0===t.length)return;const i=[];let r=[];const o=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let l=0;l<t.length;l++){const h=t[l],c=Ot(n,h.path);let u,d=!1;if(s(null!==c,"rerunTransactionsUnderNode_: relativePath should not be null."),4===h.status)d=!0,u=h.abortReason,r=r.concat(as(e.serverSyncTree_,h.currentWriteId,!0));else if(0===h.status)if(h.retryCount>=25)d=!0,u="maxretry",r=r.concat(as(e.serverSyncTree_,h.currentWriteId,!0));else{const n=mr(e,h.path,o);h.currentInputSnapshot=n;const i=t[l].update(n.val());if(void 0!==i){Vs("transaction failed: Data returned ",i,h.path);let t=yn(i);"object"==typeof i&&null!=i&&I(i,".priority")||(t=t.updatePriority(n.getPriority()));const s=h.currentWriteId,a=or(e),l=Ps(t,n,a);h.currentOutputSnapshotRaw=t,h.currentOutputSnapshotResolved=l,h.currentWriteId=cr(e),o.splice(o.indexOf(s),1),r=r.concat(rs(e.serverSyncTree_,h.path,l,h.currentWriteId,h.applyLocally)),r=r.concat(as(e.serverSyncTree_,s,!0))}else d=!0,u="nodata",r=r.concat(as(e.serverSyncTree_,h.currentWriteId,!0))}er(e.eventQueue_,n,r),r=[],d&&(t[l].status=2,a=t[l].unwatcher,setTimeout(a,Math.floor(0)),t[l].onComplete&&("nodata"===u?i.push((()=>t[l].onComplete(null,!1,t[l].currentInputSnapshot))):i.push((()=>t[l].onComplete(new Error(u),!1,null)))))}var a;br(e,e.transactionQueueTree_);for(let e=0;e<i.length;e++)it(i[e]);gr(e,e.transactionQueueTree_)}(e,Cr(e,n),i),i}function vr(e,t){let n,i=e.transactionQueueTree_;for(n=kt(t);null!==n&&void 0===As(i);)i=Ds(i,n),n=kt(t=Pt(t));return i}function Cr(e,t){const n=[];return wr(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function wr(e,t,n){const i=As(t);if(i)for(let e=0;e<i.length;e++)n.push(i[e]);Ls(t,(t=>{wr(e,t,n)}))}function br(e,t){const n=As(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,Ms(t,n.length>0?n:void 0)}Ls(t,(t=>{br(e,t)}))}function Ir(e,t){const n=qs(vr(e,t)),i=Ds(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{Er(e,t)})),Er(e,i),Fs(i,(t=>{Er(e,t)})),n}function Er(e,t){const n=As(t);if(n){const i=[];let r=[],o=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(s(o===t-1,"All SENT items should be at beginning of queue."),o=t,n[t].status=3,n[t].abortReason="set"):(s(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat(as(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===o?Ms(t,void 0):n.length=o+1,er(e.eventQueue_,qs(t),r);for(let e=0;e<i.length;e++)it(i[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class kr{constructor(e,t,n,i){this.eventType=e,this.eventRegistration=t,this.snapshot=n,this.prevName=i}getPath(){const e=this.snapshot.ref;return"value"===this.eventType?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+w(this.snapshot.exportVal())}}class Nr{constructor(e,t,n){this.eventRegistration=e,this.error=t,this.path=n}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class xr{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return Mt(this._path)?null:xt(this._path)}get ref(){return new Rr(this._repo,this._path)}get _queryIdentifier(){const e=Dn(this._queryParams),t=Xe(e);return"{}"===t?"default":t}get _queryObject(){return Dn(this._queryParams)}isEqual(e){if(!((e=D(e))instanceof xr))return!1;const t=this._repo===e._repo,n=Ft(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class Rr extends xr{constructor(e,t){super(e,t,new xn,!1)}get parent(){const e=Dt(this._path);return null===e?null:new Rr(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}class Dr{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Tt(e),n=Mr(this.ref,e);return new Dr(this._node.getChild(t),n,ln)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new Dr(n,Mr(this.ref,t),ln))))}hasChild(e){const t=new Tt(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ar(e,t){return(e=D(e))._checkNotDeleted("ref"),void 0!==t?Mr(e._root,t):e._root}function Mr(e,t){var n,i,s,r;return null===kt((e=D(e))._path)?(n="child",i="path",r=!1,(s=t)&&(s=s.replace(/^\/*\.info(\/|$)/,"/")),Gs(n,i,s,r)):Gs("child","path",t,!1),new Rr(e._repo,At(e._path,t))}function Or(e){return Ks("remove",e._path),Lr(e,null)}function Lr(e,t){e=D(e),Ks("set",e._path),$s("set",t,e._path,!1);const n=new p;return ur(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function Fr(e,t){Ys("update",t,e._path,!1);const n=new p;return function(e,t,n,i){_r(e,"update",{path:t.toString(),value:n});let s=!0;const r=or(e),o={};if(Ze(n,((n,i)=>{s=!1,o[n]=Ns(At(t,n),yn(i),e.serverSyncTree_,r)})),s)He("update() called with empty data.  Don't do anything."),fr(0,i,"ok",void 0);else{const s=cr(e),r=os(e.serverSyncTree_,t,o,s);Js(e.eventQueue_,r),e.server_.merge(t.toString(),n,((n,r)=>{const o="ok"===n;o||Ve("update at "+t+" failed: "+n);const a=as(e.serverSyncTree_,s,!o),l=a.length>0?yr(e,t):t;er(e.eventQueue_,l,a),fr(0,i,n,r)})),Ze(n,(n=>{const i=Ir(e,At(t,n));yr(e,i)})),er(e.eventQueue_,t,[])}}(e._repo,e._path,t,n.wrapCallback((()=>{}))),n.promise}function qr(e){return function(e,t){const n=ds(e.serverSyncTree_,t);return null!=n?Promise.resolve(n):e.server_.get(t).then((n=>{const i=yn(n).withIndex(t._queryParams.getIndex()),s=ls(e.serverSyncTree_,t._path,i);return Zs(e.eventQueue_,t._path,s),Promise.resolve(i)}),(n=>(_r(e,"get for query "+w(t)+" failed: "+n),Promise.reject(new Error(n)))))}((e=D(e))._repo,e).then((t=>new Dr(t,new Rr(e._repo,e._path),e._queryParams.getIndex())))}class Wr{constructor(e){this.callbackContext=e}respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new kr("value",this,new Dr(e.snapshotNode,new Rr(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Nr(this,e,t):null}matches(e){return e instanceof Wr&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}class Ur{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Nr(this,e,t):null}createEvent(e,t){s(null!=e.childName,"Child events should have a childName.");const n=Mr(new Rr(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new kr(e.type,this,new Dr(e.snapshotNode,n,i),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Ur&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}}function jr(e,t,n,i,s){let r;if("object"==typeof i&&(r=void 0,s=i),"function"==typeof i&&(r=i),s&&s.onlyOnce){const t=n,i=(n,i)=>{dr(e._repo,e,a),t(n,i)};i.userCallback=n.userCallback,i.context=n.context,n=i}const o=new Pr(n,r||void 0),a="value"===t?new Wr(o):new Ur(t,o);return function(e,t,n){let i;i=".info"===kt(t._path)?cs(e.infoSyncTree_,t,n):cs(e.serverSyncTree_,t,n),Zs(e.eventQueue_,t._path,i)}(e._repo,e,a),()=>dr(e._repo,e,a)}function Hr(e,t,n,i){return jr(e,"value",t,n,i)}!function(e){s(!zi,"__referenceConstructor has already been defined"),zi=e}(Rr),function(e){s(!$i,"__referenceConstructor has already been defined"),$i=e}(Rr);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Br={};let zr=!1;function $r(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||$e("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),He("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=Tr(r,s),h=l.repoInfo;void 0!==_e&&(a=_e.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,r=`http://${a}?ns=${h.namespace}`,l=Tr(r,s),h=l.repoInfo):o=!l.repoInfo.secure;const c=s&&o?new at(at.OWNER):new ot(e.name,e.options,t);Qs("Invalid Firebase Database URL",l),Mt(l.path)||$e("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let s=Br[t.name];s||(s={},Br[t.name]=s);let r=s[e.toURLString()];r&&$e("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new ir(e,zr,n,i),s[e.toURLString()]=r,r}(h,e,c,new rt(e.name,n));return new Vr(u,e)}class Vr{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(sr(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Rr(this._repo,St())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Br[t];n&&n[e.key]===e||$e(`Database ${t}(${e.repoInfo_}) has already been deleted.`),pr(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&$e("Cannot call "+e+" on a deleted database.")}}Bt.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Bt.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Pe="9.6.9",ee(new q("database",((e,{instanceIdentifier:t})=>$r(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),se("@firebase/database","0.12.6",e),se("@firebase/database","0.12.6","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
se("firebase","9.6.9","app");const Yr=function(e=function(e="[DEFAULT]"){const t=X.get(e);if(!t)throw ne.create("no-app",{appName:e});return t}(),t){return te(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw ne.create("bad-app-name",{appName:String(i)});const s=X.get(i);if(s){if(k(e,s.options)&&k(n,s.config))return s;throw ne.create("duplicate-app",{appName:i})}const r=new U(i);for(const e of J.values())r.addComponent(e);const o=new ie(e,n,r);return X.set(i,o),o}({apiKey:"AIzaSyCKn9ISD1LD-qgimgLMRDYp_ZvZ0WJPnzk",authDomain:"chat-forum-ed.firebaseapp.com",databaseURL:"https://chat-forum-ed-default-rtdb.europe-west1.firebasedatabase.app",projectId:"chat-forum-ed",storageBucket:"chat-forum-ed.appspot.com",messagingSenderId:"474960019860",appId:"1:474960019860:web:e21f1ef489196cacd54f81"}));class Gr{constructor(e,t,n,i){this.commentId=e,this.userId=t,this.userMsg=n,this.timeStamp=i,this.printUserInfo()}printUserInfo(){const e=document.createElement("p"),t=document.createElement("button");t.setAttribute("value",this.commentId);const n=document.querySelector("#database-comments");t.innerText="X",n.append(t),t.addEventListener("click",(e=>{const t=document.querySelector("#userNameInput");qr(Mr(Ar(Yr),`userInfo/${this.commentId}`)).then((e=>{if(e.exists()&&t.value==e.val().userId){Or(Ar(Yr,"/userInfo/"+this.commentId))}}))})),e.id=this.commentId,e.innerText=this.timeStamp+` User name: ${this.userId}, Message: ${this.userMsg}`;document.querySelector("#database-comments").appendChild(e)}removeMessage(){document.querySelector(`#${this.commentId}`).remove()}removeDomElement(){document.querySelector(`#${this.id}`).remove()}}(new e).makeElements();const Kr=Ar(Yr,"/userInfo");let Qr=[];Hr(Kr,(e=>{const t=e.val();document.querySelector("#database-comments").innerHTML="",Qr=[];for(const e in t)Qr.push(new Gr(e,t[e].userId,t[e].userMsg,t[e].timeStamp))})),document.querySelector("#nameInfo").addEventListener("submit",(t=>{t.preventDefault();const n=document.querySelector("#userNameInput"),i=document.querySelector("#userMessageInput");if(""==n.value)(new e).plsWriteName();else{(new e).changeElements();const t=new Date,n={userId:document.querySelector("#userNameInput").value,userMsg:document.querySelector("#userMessageInput").value,timeStamp:t.getFullYear()+" "+(t.getMonth()+1)+"/"+t.getUTCDate()+" - "+t.getHours()+":"+t.getMinutes()+":"};if(""!=i.value){const e={};e[function(e,t){e=D(e),Ks("push",e._path),$s("push",t,e._path,!0);const n=rr(e._repo),i=bn(n),s=Mr(e,i),r=Mr(e,i);let o;return o=null!=t?Lr(r,t).then((()=>r)):Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}(Kr).key]=n,Fr(Kr,e)}}if(Qr.length>24){Or(Ar(Yr,"/userInfo/"+Qr[0].commentId))}}));
//# sourceMappingURL=index.2859483f.js.map
